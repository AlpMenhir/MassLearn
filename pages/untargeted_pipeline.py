    ...
    dbc.Container([
            html.A(
                ...
                dbc.Row([
                        ...
                        dbc.Col(dbc.NavbarBrand("Untargeted Pipeline", className="ms-2")),
                    ],
                    align="center",
                    className="g-0",
                ),
...
def add_template(template_path):
    ...
    if len(template['Type_MS'].unique()) > 1:
        return False, f'{os.path.basename(template_path)} have at least two different types of MS mode, only one is possible. Verify Type_MS column values.'
    else:
